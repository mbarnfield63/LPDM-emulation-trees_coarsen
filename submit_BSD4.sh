...
start_time=$(date +%s)
python train_emulator.py "BSD" "201[4-5]" --size 17 --input_size 22 --coarsen 4 --hours_back 6 --save_name "BSD_1415_coarsened4"
...
echo "BSD Coarsen 4 runtime: $runtime seconds"