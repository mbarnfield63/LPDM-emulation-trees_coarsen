...
start_time=$(date +%s)
python train_emulator.py "BSD" "201[4-5]" --size 22 --input_size 28 --coarsen 5 --hours_back 6 --save_name "BSD_1415_coarsened5"
...
echo "BSD Coarsen 5 runtime: $runtime seconds"