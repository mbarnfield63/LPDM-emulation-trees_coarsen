...
start_time=$(date +%s)
python train_emulator.py "BSD" "201[4-5]" --size 12 --input_size 18 --coarsen 3 --hours_back 6 --save_name "BSD_1415_coarsened3"
...
echo "BSD Coarsen 3 runtime: $runtime seconds"